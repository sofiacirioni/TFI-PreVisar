...
public record GeminiProperties(String model, int timeoutSegundos, int timeoutPdfSegundos, int dpi, int reintentos) {
    public GeminiProperties {
        ...
        if (timeoutPdfSegundos <= 0) timeoutPdfSegundos = 120; // el PDF entero (visión nativa) tarda más que una página
