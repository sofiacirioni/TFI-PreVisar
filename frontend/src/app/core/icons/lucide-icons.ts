/**
 * Lucide line icons (https://lucide.dev) registered as Angular Material SVG
 * icons. Keyed by the Material Symbols name the app already uses, so existing
 * `<mat-icon svgIcon="...">` references keep working while rendering Lucide
 * paths (1.8px stroke, 24px grid) — matching the PreVisar Design System.
 *
 * Each value is the inner SVG markup; it gets wrapped with a shared
 * <svg viewBox="0 0 24 24" ...> by provideLucideIcons().
 */
export const LUCIDE_ICONS: Record<string, string> = {
  ...
  rule: '<path d="m3 7 2 2 4-4"/><path d="M13 8h8"/><path d="m3 17 2 2 4-4"/><path d="M13 18h8"/>',
  ...
  picture_as_pdf:
    '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M9 15v-4h1.5a1.5 1.5 0 0 1 0 3H9"/><path d="M14 18v-7h1.5a2 2 0 0 1 0 4H14"/>',
  ...
  // estado / proceso
  autorenew: '<path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/>',
  schedule: '<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>',
  warning_amber:
    '<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/>',
  auto_awesome:
    '<path d="M9.9 2.3a.5.5 0 0 1 .95 0l1.36 4.07a.5.5 0 0 0 .32.32l4.07 1.36a.5.5 0 0 1 0 .95l-4.07 1.36a.5.5 0 0 0-.32.32L10.85 14.8a.5.5 0 0 1-.95 0L8.54 10.7a.5.5 0 0 0-.32-.32L4.15 9.02a.5.5 0 0 1 0-.95l4.07-1.36a.5.5 0 0 0 .32-.32z"/><path d="M18 14v4"/><path d="M16 16h4"/><path d="M6 17v2"/><path d="M5 18h2"/>',
  construction:
    '<rect width="20" height="8" x="2" y="6" rx="1"/><path d="M17 14v7"/><path d="M7 14v7"/><path d="M17 3v3"/><path d="M7 3v3"/><path d="M10 14 2.3 6.3"/><path d="m14 6 7.7 7.7"/><path d="m8 6 8 8"/>',
